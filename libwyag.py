...
def main(argv=sys.argv[1:]):
    ...
    def repo_path(repo, *path):
        """Returns the path to a file in the repository"""
    ...
    def repo_file(repo, *path, mkdir=False):
        ...
        if repo_dir(repo, *path[:-1], mkdir=mkdir): #dont get confuse it just check if the prev directory is there or not 
    ...
    def repo_create(path):
        ...
        # First, we make sure the path either doesn't exist or is a
        # directory, and that .git doesn't exist
    ...
    class GitObject(object):
        ...
        def serialize(self, repo): # Enforcing an implementation
            raise Exception("Unimplemented")
        
        def deserialize(self, data):
            raise Exception("Unimplemented") 
        
        def init(): # not enforcing implementaion
            pass
